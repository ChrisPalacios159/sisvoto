...
export default function Sidebar({
  ...
  const sidebarContent = (
    ...
    >
      ...
      <div className="relative overflow-hidden px-5 pt-6 pb-5">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-bold text-white">Sistema Electoral</span>
            <div className="flex items-center gap-1.5 mt-0.5">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
              <span className="text-[10px] font-medium text-orange-200/60">Monitoreo en Vivo</span>
            </div>
          </div>
      ...
      {/* Separator */}
      <div className="mx-4 h-px" style={{ background: 'linear-gradient(90deg, transparent, rgba(255,107,0,0.15), transparent)' }} />
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? 'text-white'
                      : 'text-orange-100/50 hover:text-orange-100/80 hover:bg-white/[0.04]'
                  }
                `}
                style={isActive ? {
              ...
              >
                ...
                <Icon className={`h-5 w-5 transition-colors duration-200 ${
                  isActive ? 'text-orange-400' : 'text-orange-200/40 group-hover:text-orange-200/70'
                }`} />
      ...
      {/* User Section */}
      <div className="px-3 py-3" style={{ borderTop: '1px solid rgba(255,107,0,0.08)' }}>
        <div className="flex items-center gap-3 rounded-lg px-3 py-2.5" style={{ background: 'rgba(255,255,255,0.03)' }}>
          ...
          <div className="flex flex-1 flex-col overflow-hidden">
            <span className="truncate text-sm font-medium text-orange-100/80">Administrador</span>
            <span className="truncate text-[10px] text-orange-200/30">admin@electoral.gob</span>
          </div>
          <Button
            variant="ghost"
            size="icon"
